# Constants
[Git Source](https://github.com/VerisLabs/KAM/blob/2a21b33e9cec23b511a8ed73ae31a71d95a7da16/src/errors/Errors.sol)
...
```solidity
string constant PARAMETERCHECKER_AMOUNT_EXCEEDS_MAX_SINGLE_TRANSFER = "PC3"
```

### PARAMETERCHECKER_RECEIVER_NOT_ALLOWED

```solidity
string constant PARAMETERCHECKER_RECEIVER_NOT_ALLOWED = "PC4"
```
